<template>
  <v-app id="home" :style="{background: $vuetify.theme.themes.dark.background}">
    ...
    <v-container fluid>
        <v-row>
            <v-col cols="6">
              <v-img src="1.jpeg" contain max-height="500"></v-img>
            </v-col>
            <v-col cols="6">
              <h5 class="red--text text-darken-4 top"> Hey! This is me, Mohsin  </h5>
              <h1 class="white--text ">Frontend Developer </h1>
              <p class="grey--text "> Lorem ipsum dolor sit amet, consectetur adipisicing <br/>elit. Unde enim fugit a delectus accusamus quos omnis nesciunt doloribus. <br/> Animi earum quasi soluta omnis quas,  <br/>quo odio modi ut? Optio ex est culpa? </p>
...
<script>
  ...
  import FooBar from "../components/FootBar.vue";
